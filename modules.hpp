/*
  Author: Cephei
  Description: Add an include for each module you want to use
  Example: #include "modulename\module.hpp"
  Notes: module.hpp needs to be present and properly configured
*/


#include "a3g-loadout\module.hpp"
#include "a3g-spectator-cam\module.hpp"
#include "agm-bleed-param\module.hpp"
#include "agm-default\module.hpp"
